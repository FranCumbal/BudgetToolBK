...
from views.plan_editor import PandasModel  # Asegúrate de tener import correcto
import pandas as pd


class PlanEditorWindow(QWidget):
    def __init__(self, df: pd.DataFrame, excel_path: str):
        super().__init__()
        self.setWindowTitle("Editor de Plan Anual de Actividades")
        self.df = df
        ...
        self.model = PandasModel(df_with_total)
